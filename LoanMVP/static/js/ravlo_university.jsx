...
function App() {
  ...
  const visiblePaths = useMemo(() => {
    const group = CAREER_PATHS.find(item => item.category === activeCategory);
...
const rootEl = document.getElementById('ravlo-university-root');
const root = ReactDOM.createRoot(rootEl);
root.render(<App />);
rootEl.setAttribute('data-academy-ready', 'true');
