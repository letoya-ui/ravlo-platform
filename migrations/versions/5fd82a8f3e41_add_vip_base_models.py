...
def upgrade():
    ...
    if not inspector.has_table("vip_profiles"):
        op.create_table(
            "vip_profiles",
    ...
    if not inspector.has_table("vip_contacts"):
        op.create_table(
            "vip_contacts",
            sa.Column("id", sa.Integer(), primary_key=True),
            sa.Column("created_at", sa.DateTime(), nullable=True),
    ...
    if not inspector.has_table("vip_listings"):
        op.create_table(
            "vip_listings",
            sa.Column("id", sa.Integer(), primary_key=True),
            sa.Column("created_at", sa.DateTime(), nullable=True),
    ...
    if not inspector.has_table("vip_interactions"):
        op.create_table(
            "vip_interactions",
            sa.Column("id", sa.Integer(), primary_key=True),
            sa.Column("created_at", sa.DateTime(), nullable=True),
    ...
    if not inspector.has_table("vip_expenses"):
        op.create_table(
            "vip_expenses",
            sa.Column("id", sa.Integer(), primary_key=True),
            sa.Column("created_at", sa.DateTime(), nullable=True),
    ...
    if not inspector.has_table("vip_income"):
        op.create_table(
            "vip_income",
            sa.Column("id", sa.Integer(), primary_key=True),
            sa.Column("created_at", sa.DateTime(), nullable=True),
    ...
    if not inspector.has_table("vip_budgets"):
        op.create_table(
            "vip_budgets",
            sa.Column("id", sa.Integer(), primary_key=True),
            sa.Column("created_at", sa.DateTime(), nullable=True),
    ...
    if not inspector.has_table("vip_assistant_suggestions"):
        op.create_table(
    ...
    if not inspector.has_table("vip_assistant_actions"):
        op.create_table(
    ...
    if not inspector.has_table("vip_notifications"):
        op.create_table(
            "vip_notifications",
            sa.Column("id", sa.Integer(), primary_key=True),
            sa.Column("created_at", sa.DateTime(), nullable=True),
