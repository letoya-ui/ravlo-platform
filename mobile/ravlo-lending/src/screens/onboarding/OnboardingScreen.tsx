...
const SLIDES: SlideData[] = [
  {
    ...
    title: 'Welcome to Ravlo Lending',
    subtitle: 'Your complete loan pipeline, anywhere you go.',
  },
  {
    key: '2',
    icon: 'documents-outline',
    title: 'Manage Your Pipeline',
    subtitle: 'Track every loan from application to close with real-time updates.',
  },
  {
    key: '3',
    icon: 'sparkles-outline',
    title: 'Meet Elena',
    subtitle: 'Your AI lending assistant. Ask anything about guidelines, compliance, or borrower strategy.',
  },
  {
    key: '4',
    icon: 'rocket-outline',
    title: "Let's Get Started",
    subtitle: 'Sign in to access your pipeline.',
    showButton: true,
  },
];
