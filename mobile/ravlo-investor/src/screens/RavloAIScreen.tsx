...
export default function RavloAIScreen() {
  const [messages, setMessages] = useState<Message[]>([
    { id: '0', role: 'assistant', content: "Hi! I'm Ravlo AI, your real estate investment intelligence assistant. Ask me about deal analysis, market trends, BRRRR strategy, fix-and-flip ROI, or any investment question." },
  ]);
      ...
      <View style={styles.header}>
        <View style={styles.avatarRow}>
          ...
          <View>
            ...
            <Text style={styles.headerSub}>Real Estate Intelligence</Text>
          </View>
        </View>
      </View>
      <FlatList
      ...
      <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : 'height'}>
        <View style={styles.inputBar}>
          <TextInput
            ...
            placeholder="Ask about deals, ROI, strategy…"
